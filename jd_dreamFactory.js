 ...
 */
let mycode = 'gaVXW_NJ0KPEA2LyUhoXzA=='  //(这个值没有卵用)、仅作杜绝我的用户帮别人助力
...
const inviteCodes = ['rJ2BWB1L9UYu28Zz2_ByGw==',"xhgqZLwvcbVzzjnYpHRcLg==","o1oHgf3t3J2heGLRxRXFWDPSScfE9PBkf3Ovt1573wE="];
...
async function stealFriend() {
  ...
  for (let i = 0; i < $.friendList.length; i++) {
    ...
    if (pin === 'rJ2BWB1L9UYu28Zz2_ByGw==' || pin === 'Bo-jnVs_m9uBvbRzraXcSA==') {
      continue
    }
        ...
        if (err) {
          ...
          if (safeGet(data)) {
            ...
            if (data['ret'] === 0) {
              ...
              if($.nickName == 'jd_159275hdb'){   //只给我自己助力
                mycode = userTuanInfo.tuanId;
              }
            } else {
