...
const inviteCodes = [`P04z54XCjVUnoaW5m9cZ2ar3nhCnBWKdDB_Cyc`, 'P04z54XCjVUnoaW5jQLAGT-1H9KnOKNNJeGZ7C-Nw', `P04z54XCjVUnoaW5m9cZ2b-jChKkjy2kzuvvSA`, `P04z54XCjVUnoaW5m9cZ2aqiypKlqKwl0ZgFGA`];
!(async () => {
  await requireConfig();
  if (!cookiesArr[0]) {
